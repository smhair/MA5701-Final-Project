...
#the variances are not equal, hence we will use the welch t-test for testing the differnece in means of both vaccination ratio between risk levels 2 & 3

t.test(data$metrics.vaccinationsCompletedRatio~data$riskLevels.overall, alt='t', conf.level=.95)
#By the Welch Two Sample t-test, we can reject H0: mu1=mu2
