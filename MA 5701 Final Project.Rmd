...
count(sample_covid_clean)#check count
sample_ordered=sample_covid_clean[
  with(sample_covid_clean, order(riskLevels.overall)),
]
sample_ordered

dplyr::filter(riskLevels.overall == c('2','3'))

var.test(metrics.vaccinationsCompletedRatio~riskLevels.overall, ratio=1, alternative = "two.sided")
levels(riskLevels.overall)
