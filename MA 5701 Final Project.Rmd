...
```{r Scatter Plot}
sample_covid_clean %>% 
  ggplot(aes(actuals.hospitalBeds.capacity, actuals.deaths))+
  geom_point()+
  xlab("Hospital Bed Capacity")+
...
```{r QQ Plots}
qqnorm(actuals.hospitalBeds.capacity, main='Hospital Bed Capacity QQ Plot', xlab='Z-Value', ylab='Variable X-Value', col='Blue')
qqline(actuals.hospitalBeds.capacity)

qqnorm(actuals.deaths, main='Total Covid Deaths QQ Plot', xlab='Z-Value', ylab='Variable X-Value',  col='Blue')
qqline(actuals.deaths)

qqnorm(metrics.vaccinationsCompletedRatio, main='Vaccination Ratio QQ Plot', xlab='Z-Value', ylab='Variable X-Value',  col='Blue')
